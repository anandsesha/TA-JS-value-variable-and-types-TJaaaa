...
let userName = user;
console.log(`The value in unserName is ${userName} and the value in user is ${user}`);
...
*/
let numA = Number(prompt("Input your first number")),numB = Number(prompt("Input your second number"));
let sum = numA + numB;
